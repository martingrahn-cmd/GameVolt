...
export const ACHIEVEMENTS = [
  ...
  { id: 'all_tracks', name: 'Grand Tour', desc: 'Race on all twelve circuits', icon: '🗺️', form: 'disc', tier: 'bronze' },
...
export class Achievements {
  ...
  unlock(id) {
    ...
    try { window.GameVolt?.achievements?.unlock?.(id); } catch { /* cloud trophies are a bonus */ }
    this.enqueue(def);
