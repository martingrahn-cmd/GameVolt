...
INSERT INTO achievement_defs (id, game_id, title, description, icon, tier, sort_order) VALUES
  ...
  ('manga-match3-first_match',    'manga-match3', 'First Bloom',       'Complete your first match',               '🌸', 'bronze', 1),
  ('manga-match3-stage_1',        'manga-match3', 'Academy Student',   'Clear Stage 1',                           '🏫', 'bronze', 2),
  ('manga-match3-stage_5',        'manga-match3', 'Rising Star',       'Clear Stage 5',                           '⭐', 'bronze', 3),
  ('manga-match3-stage_10',       'manga-match3', 'Portal Opener',     'Clear World 1 (Stage 10)',                '🌙', 'bronze', 4),
  ('manga-match3-first_special',  'manga-match3', 'Special Discovery', 'Create your first special tile',          '💎', 'bronze', 5),
  ('manga-match3-first_line',     'manga-match3', 'Line Blast',        'Create a line attack tile',               '⚡', 'bronze', 6),
  ('manga-match3-first_bomb',     'manga-match3', 'Bomber',            'Create a bomb tile',                      '💥', 'bronze', 7),
  ('manga-match3-first_color',    'manga-match3', 'Color Burst',       'Create a color bomb',                     '🌈', 'bronze', 8),
  ('manga-match3-chain_2',        'manga-match3', 'Chain Starter',     'Achieve a 2-chain combo',                 '🔗', 'bronze', 9),
  ('manga-match3-fever_first',    'manga-match3', 'First Fever',       'Activate Fever Mode for the first time',  '🔥', 'bronze', 10),
  ('manga-match3-score_5k',       'manga-match3', 'Point Collector',   'Score 5,000 points in a single stage',    '📊', 'bronze', 11),
  ('manga-match3-clear_50',       'manga-match3', 'Tile Sweeper',      'Clear 50 tiles in a single stage',        '🧹', 'bronze', 12),
  ('manga-match3-stars_10',       'manga-match3', 'Star Gazer',        'Earn 10 stars total',                     '✨', 'bronze', 13),
  ('manga-match3-daily_first',    'manga-match3', 'Daily Player',      'Complete your first daily challenge',      '📅', 'bronze', 14),
  ('manga-match3-coins_500',      'manga-match3', 'Coin Collector',    'Accumulate 500 coins',                    '🪙', 'bronze', 15),
  -- Manga Match: Silver (10)
  ('manga-match3-stage_20',       'manga-match3', 'Portal Guardian',   'Clear World 2 (Stage 20)',                '🏯', 'silver', 16),
  ('manga-match3-chain_4',        'manga-match3', 'Chain Master',      'Achieve a 4-chain combo',                 '⛓️', 'silver', 17),
  ('manga-match3-score_10k',      'manga-match3', 'High Scorer',       'Score 10,000 points in a single stage',   '🏆', 'silver', 18),
  ('manga-match3-three_stars',    'manga-match3', 'Perfectionist',     'Get 3 stars on any stage',                '🌟', 'silver', 19),
  ('manga-match3-stars_30',       'manga-match3', 'Star Hunter',       'Earn 30 stars total',                     '💫', 'silver', 20),
  ('manga-match3-ink_clear_20',   'manga-match3', 'Ink Eraser',        'Clear 20 ink obstacles total',            '🖋️', 'silver', 21),
  ('manga-match3-locks_break_15', 'manga-match3', 'Locksmith',         'Break 15 locks total',                    '🔓', 'silver', 22),
  ('manga-match3-fever_5',        'manga-match3', 'Fever Addict',      'Activate Fever Mode 5 times',             '🔥', 'silver', 23),
  ('manga-match3-daily_streak_3', 'manga-match3', 'Dedicated',         'Reach a 3-day daily challenge streak',    '📆', 'silver', 24),
  ('manga-match3-powerup_use_5',  'manga-match3', 'Power User',        'Use 5 power-ups total',                   '⚗️', 'silver', 25),
  -- Manga Match: Gold (5)
  ('manga-match3-stage_30',       'manga-match3', 'Final Panel',       'Clear all 30 stages',                     '👑', 'gold', 26),
  ('manga-match3-chain_6',        'manga-match3', 'Chain Demon',       'Achieve a 6-chain combo',                 '💀', 'gold', 27),
  ('manga-match3-score_20k',      'manga-match3', 'Score Legend',      'Score 20,000 points in a single stage',   '🎌', 'gold', 28),
...
-- ============================================================
-- Manny the Mole (added 2026-08-14): game row + 31 achievement defs.
-- Same content as sql/manny-the-mole-achievements.sql.
-- ============================================================
