-- New Dollarton uses the shared GameVolt SDK save table with the legacy game_id='simbuild'.
...
INSERT INTO public.games (id, title, description, thumbnail_url) VALUES
  ('simbuild', 'New Dollarton', 'Build and manage a growing 3D city in your browser.', NULL)
