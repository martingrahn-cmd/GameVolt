...
const ASSETS = [
  ...
  './tt-core.js?v=0.29.0',
  './tt-ai.js?v=0.29.0',
  './assets/hit.mp3?v=0.29.0',
  './assets/bounce.mp3?v=0.29.0',
  './assets/cheer.mp3?v=0.29.0',
  './assets/net.mp3?v=0.29.0',
  './assets/opp-hans.png?v=0.29.0',
  './assets/opp-hummel.png?v=0.29.0',
  './assets/opp-chongli.png?v=0.29.0',
  './assets/opp-player.png?v=0.29.0',
  './icons/icon-192.png',
  './icons/icon-512.png',
