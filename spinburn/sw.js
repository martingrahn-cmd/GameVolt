...
const ASSETS = [
  ...
  './tt-ai.js?v=0.42.0',
  './sb-net.js?v=0.42.0',
  './tt-achievements.js?v=0.42.0',
  './assets/hit.mp3?v=0.42.0',
  './assets/bounce.mp3?v=0.42.0',
  './assets/cheer.mp3?v=0.42.0',
  './assets/net.mp3?v=0.42.0',
  './assets/crowd.mp3?v=0.42.0',
  './assets/winfare.mp3?v=0.42.0',
  './assets/lose.mp3?v=0.42.0',
  './assets/matchpoint.mp3?v=0.42.0',
  './assets/vo-matchpoint.mp3?v=0.42.0',
  './assets/vo-intro.mp3?v=0.42.0',
  './assets/opp-hans.png?v=0.42.0',
  './assets/opp-hummel.png?v=0.42.0',
  './assets/opp-chongli.png?v=0.42.0',
  './assets/opp-player.png?v=0.42.0',
  './icons/icon-192.png',
  './icons/icon-512.png',
