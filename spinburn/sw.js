...
const ASSETS = [
  ...
  './tt-ai.js?v=0.43.1',
  './sb-net.js?v=0.43.1',
  './tt-achievements.js?v=0.43.1',
  './assets/hit.mp3?v=0.43.1',
  './assets/bounce.mp3?v=0.43.1',
  './assets/cheer.mp3?v=0.43.1',
  './assets/net.mp3?v=0.43.1',
  './assets/crowd.mp3?v=0.43.1',
  './assets/winfare.mp3?v=0.43.1',
  './assets/lose.mp3?v=0.43.1',
  './assets/matchpoint.mp3?v=0.43.1',
  './assets/vo-matchpoint.mp3?v=0.43.1',
  './assets/vo-intro.mp3?v=0.43.1',
  './assets/opp-hans.png?v=0.43.1',
  './assets/opp-hummel.png?v=0.43.1',
  './assets/opp-chongli.png?v=0.43.1',
  './assets/opp-player.png?v=0.43.1',
  './icons/icon-192.png',
  './icons/icon-512.png',
